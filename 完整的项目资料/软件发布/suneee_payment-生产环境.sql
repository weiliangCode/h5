...
CREATE TABLE `pay_request` (
  ...
  `notify_json` varchar(2000) DEFAULT NULL,
  PRIMARY KEY (`pay_request_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1003165 DEFAULT CHARSET=utf8;
...
INSERT INTO `payment_parameter_define` VALUES ('21', '3', '1', 'apiclient_cert.pem', '7', '100', 'string', '证书');
INSERT INTO `payment_parameter_define` VALUES ('22', '3', '1', 'apiclient_key.pem', '7', '100', 'string', '证书');
INSERT INTO `payment_parameter_define` VALUES ('23', '93', '1', 'rootca.pem', '3', '100', 'string', '证书');
...
INSERT INTO `payment_parameter_define` VALUES ('28', '3', '2', 'apiclient_cert.pem', '7', '100', 'string', '证书');
INSERT INTO `payment_parameter_define` VALUES ('29', '3', '2', 'apiclient_key.pem', '7', '100', 'string', '证书');
INSERT INTO `payment_parameter_define` VALUES ('30', '93', '2', 'rootca.pem', '3', '100', 'string', '证书');
...
INSERT INTO `payment_parameter_define` VALUES ('37', '99', '1', 'cacert', '3', '10000', 'string', '支付宝证书');
...
INSERT INTO `payment_parameter_define` VALUES ('59', '4', '1', 'account', '3', '1000', 'string', '工商银行账户名');
INSERT INTO `payment_parameter_define` VALUES ('60', '4', '1', 'merID', '3', '100', '唯一确定一个商户的代码，由商户在工行开户时，由工行告知商户', '商户代码');
INSERT INTO `payment_parameter_define` VALUES ('61', '4', '1', 'merAcct', '3', '100', '商户付给银行手续费的账户', '商户账号');
INSERT INTO `payment_parameter_define` VALUES ('62', '4', '1', 'merCert', '7', '1000', 'string', '商城证书公钥');
INSERT INTO `payment_parameter_define` VALUES ('63', '4', '1', 'PW', '3', '1000', 'string', '工行对接密码');
INSERT INTO `payment_parameter_define` VALUES ('64', '4', '1', 'private_file', '7', '1000', 'string', '商户私钥文件');
INSERT INTO `payment_parameter_define` VALUES ('65', '3', '3', 'apiclient_cert.pem', '7', '1000', 'string', '证书');
INSERT INTO `payment_parameter_define` VALUES ('66', '3', '4', 'apiclient_key.pem', '7', '1000', 'string', '证书');
INSERT INTO `payment_parameter_define` VALUES ('67', '3', '3', 'apiclient_key.pem', '7', '1000', 'string', '证书');
INSERT INTO `payment_parameter_define` VALUES ('68', '3', '4', 'apiclient_cert.pem', '7', '1000', 'string', '证书');
INSERT INTO `payment_parameter_define` VALUES ('69', '4', '2', 'account', '3', '1000', 'string', '工商银行账户名');
INSERT INTO `payment_parameter_define` VALUES ('70', '4', '2', 'merID', '3', '100', '唯一确定一个商户的代码，由商户在工行开户时，由工行告知商户', '商户代码');
INSERT INTO `payment_parameter_define` VALUES ('71', '4', '2', 'merAcct', '3', '100', '商户付给银行手续费的账户', '商户账号');
INSERT INTO `payment_parameter_define` VALUES ('72', '4', '2', 'merCert', '7', '1000', 'string', '商城证书公钥');
INSERT INTO `payment_parameter_define` VALUES ('73', '4', '2', 'PW', '3', '1000', 'string', '工行对接密码');
INSERT INTO `payment_parameter_define` VALUES ('74', '4', '2', 'private_file', '7', '1000', 'string', '商户私钥文件');
INSERT INTO `payment_parameter_define` VALUES ('75', '4', '3', 'account', '3', '1000', 'string', '工商银行账户名');
INSERT INTO `payment_parameter_define` VALUES ('76', '4', '3', 'merID', '3', '100', '唯一确定一个商户的代码，由商户在工行开户时，由工行告知商户', '商户代码');
INSERT INTO `payment_parameter_define` VALUES ('77', '4', '3', 'merAcct', '3', '100', '商户付给银行手续费的账户', '商户账号');
INSERT INTO `payment_parameter_define` VALUES ('78', '4', '3', 'merCert', '7', '1000', 'string', '商城证书公钥');
INSERT INTO `payment_parameter_define` VALUES ('79', '4', '3', 'PW', '3', '1000', 'string', '工行对接密码');
INSERT INTO `payment_parameter_define` VALUES ('80', '4', '3', 'private_file', '7', '1000', 'string', '商户私钥文件');
INSERT INTO `payment_parameter_define` VALUES ('81', '4', '4', 'account', '3', '1000', 'string', '工商银行账户名');
INSERT INTO `payment_parameter_define` VALUES ('82', '4', '4', 'merID', '3', '100', '唯一确定一个商户的代码，由商户在工行开户时，由工行告知商户', '商户代码');
INSERT INTO `payment_parameter_define` VALUES ('83', '4', '4', 'merAcct', '3', '100', '商户付给银行手续费的账户', '商户账号');
INSERT INTO `payment_parameter_define` VALUES ('84', '4', '4', 'merCert', '7', '1000', 'string', '商城证书公钥');
INSERT INTO `payment_parameter_define` VALUES ('85', '4', '4', 'PW', '3', '1000', 'string', '工行对接密码');
INSERT INTO `payment_parameter_define` VALUES ('86', '4', '4', 'private_file', '7', '1000', 'string', '商户私钥文件');
INSERT INTO `payment_parameter_define` VALUES ('87', '6', '1', 'InstitutionID', '3', '10', 'int', 'InstitutionID');
INSERT INTO `payment_parameter_define` VALUES ('88', '1', '1', 'alipay_public_key.pem', '7', '1000', 'string', '公钥');
INSERT INTO `payment_parameter_define` VALUES ('89', '1', '1', 'rsa_private_key.pem', '7', '1000', 'string', '私钥');
INSERT INTO `payment_parameter_define` VALUES ('90', '1', '2', 'alipay_public_key.pem', '7', '1000', 'string', '公钥');
INSERT INTO `payment_parameter_define` VALUES ('91', '1', '2', 'rsa_private_key.pem', '7', '1000', 'string', '私钥');
INSERT INTO `payment_parameter_define` VALUES ('92', '1', '1', 'app_id', '3', '100', 'string', 'app_id');
INSERT INTO `payment_parameter_define` VALUES ('93', '1', '2', 'app_id', '3', '100', 'string', 'app_id');
INSERT INTO `payment_parameter_define` VALUES ('94', '1', '3', 'app_id', '3', '100', 'string', 'app_id');
INSERT INTO `payment_parameter_define` VALUES ('95', '1', '4', 'app_id', '3', '100', 'string', 'app_id');
INSERT INTO `payment_parameter_define` VALUES ('96', '5', '1', 'institutionID', '3', '100', 'string', '中金商户编号');
INSERT INTO `payment_parameter_define` VALUES ('97', '5', '1', 'payment.cer', '7', '1000', 'string', '中金邮件提供的证书');
INSERT INTO `payment_parameter_define` VALUES ('98', '5', '1', 'my.pfx', '7', '1000', 'string', '商户导出的私钥');
INSERT INTO `payment_parameter_define` VALUES ('99', '5', '1', 'password', '3', '100', 'string', '商户导出的私钥使用的密码');
INSERT INTO `payment_parameter_define` VALUES ('100', '5', '1', 'account', '3', '1000', 'string', 'account');
